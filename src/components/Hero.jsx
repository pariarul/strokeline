        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-sm leading-relaxed font-medium">
                We engineer high-fidelity digital solutions for the world&apos;s leading financial and publishing institutions. Precision in every stroke.
              </p>
              ...
              <div className="flex flex-col gap-6 w-full md:w-auto">
                ...
                >
                  ...
                  <span className="relative font-black uppercase tracking-widest text-[10px] flex items-center gap-2 group-hover:text-white">
                    Explore Our Craft <ArrowUpRight size={16} />
                  </span>
                </Link>
                <div className="flex items-baseline gap-2 pl-4">
                    <span className="text-brand-orange font-black text-2xl">99.9%</span>
                    <span className="text-[10px] uppercase font-bold tracking-widest text-zinc-400">Accuracy Benchmark</span>
                </div>
              </div>
            </motion.div>
          </div>

          {/* Side Visual Element - Asymmetrical */}
          <div className="lg:col-span-4 hidden lg:block">
            ...
            >
              ...
              {/* Floating Content within Hero side element */}
              <div className="absolute inset-0 p-12 flex flex-col justify-end gap-8">
                {[
                    { icon: BarChart3, title: "Fin-Publishing" },
                    { icon: Globe2, title: "Localization" },
                    { icon: FileJson, title: "Data-Conversion" }
                ].map((item, i) => (
                    <motion.div 
                        key={i}
                        whileHover={{ x: 10 }}
