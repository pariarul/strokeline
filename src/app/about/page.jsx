                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-end">
                        <div className="lg:col-span-8 space-y-8">
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-brand-orange">Est. 2022</span>
                        ...
                        <div className="lg:col-span-4 lg:pl-10">
                            ...
                            >
                                Strokeline Design Services Private Limited (originally Strokeline Services) is a trusted partner for the publishing and language service industry.
                            </motion.p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">
                                <p>
                                    Founded in 2022 in Vankayalapadu, Inkollu, India, we have steadily evolved into a trusted partner for the publishing and language service industry. By blending innovative technical solutions with a robust strategic approach, we have expanded our capacity and diversified our service offerings.
                                </p>
                                <p>
                                    Due to our commitment to excellence, we have expanded our operations across Andhra Pradesh, ensuring closer collaboration and better service for our growing global clientele.
                                </p>
                            </div>
                        </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
                        <div className="lg:col-span-5">
                            <SectionTitle
                                ...
                                description="Guiding operations with industry best practices and a decade of specialized experience."
                                centered={false}
                            />
                        </div>
                        <div className="lg:col-span-7 space-y-8 pt-8">
                            <p className="text-xl text-zinc-500 font-medium leading-relaxed">
                                At the heart of Strokeline&apos;s success is leadership with over a decade of experience in the pre-press industry. This expertise ensures that our operations meet international publishing requirements through qualitative functional performance.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8">
                                {[
                                    "Qualitative Functional Performance",
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center space-y-12">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl font-medium opacity-90 leading-relaxed">
                            We believe success lies in the perfect balance of innovation, expertise, and operational excellence. With a forward-looking vision, we continue to strengthen our role as a reliable partner in the global industry.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-32 bg-white dark:bg-black">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <SectionTitle
                        ...
                        description="Our innovations enable swift turnaround times and top-notch quality outputs."
                    />
