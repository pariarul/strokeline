                        ...
                        <div className="lg:col-span-8 lg:pl-12">
                            ...
                            >
                                <p className="text-2xl md:text-3xl text-zinc-500 font-medium leading-relaxed">
                                    Founded in 2022 as <span className="text-zinc-900 dark:text-zinc-100 font-black">Strokeline Services</span> in Vankayalapadu, we have evolved into a trusted partner for the publishing industry. With leadership boasting <span className="text-zinc-900 dark:text-zinc-100 font-black">over a decade of experience</span>, we continue to expand across Andhra Pradesh.
                                </p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-12 pt-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm font-bold">Vankayalapadu, Andhra Pradesh</p>
                                    </div>
                                    <div className="space-y-2">
